...
<div id="pesan" class="row mb-3">
    <div class="col">
        ...
        ?>    
                ...
                $insertSQL = "INSERT INTO karyawan (nik, nama, tanggal_mulai, gaji_pokok, status_karyawan, bagian_id) 
                              VALUES ('$nik', '$nama', '$tanggal_mulai', '$gaji_pokok', '$status_karyawan', '$bagian_id')";
        ...
        <div class="card px-3 py-3">
            <form action="" method="post">
                ...
                <div class="mb-3 mt-3">
                    ...
                    ?>
                    <select class="form-select" aria-label="Default select example" name="bagian_id" required>
